...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD4QJZdpliaHhcZKH9pvok9k2DmPX2L5qu2AgeJu0kNpt2iaGOzSQb6d4f4Xnu4YRk8ZsQLqicxic0rUqg/640?wx_fmt=jpeg&from=appmsg)
...
由于医学图像和自然图像在成像原理、数据量、数据质量等方面存在较大差异，以及缺少大规模医学图像基准数据集，这是导致AI在医学领域进展缓慢的原因之一。构建大规模基准数据集和可靠的基线模型，能够推动AI在医疗领域的快速发展，加速医疗向更通用的方向转变。

  

**11月29日（周三）19:00 四川大学人工智能专业博士、上海人工智能实验室通用视觉团队见习研究员 程俊龙** 将通过以下内容分享他们在医学图像分割基础模型上的实践与探索，欢迎报名~

  

**亮点介绍：**

**1\. 如何创建医疗领域交互式分割基准数据集 SA-Med2D-20M**

**2\. 通过全面微调SAM来解决自然图像和医学图像之间的领域差异**

**3\. 对SAM-Med2D模型在医学图像领域的性能进行多维度评估**

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD4QJZdpliaHhcZKH9pvok9k29KVBODxI48EiaDzjkViblaDyquyicrxXjX2K9hsdQ3Qyb87au2cQlxPmg/640?wx_fmt=jpeg&from=appmsg)

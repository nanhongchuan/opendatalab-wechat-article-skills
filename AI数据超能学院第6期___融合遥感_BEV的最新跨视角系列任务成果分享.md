...
想象一下，我们的城市如同一个精密的拼图，每一栋建筑都是不可或缺的一块。在这个拼图中，如何才能精确描绘出每栋建筑的轮廓与细节？

  

从高空俯瞰的**卫星遥感图像**，可以提供建筑的宏观轮廓信息；而**地面街景图像**则能补充建筑立面的微观细节，那有没有一种方法，能将这两种视角有效融合，以实现对建筑属性的全面感知？

  

**12月11日（周三）19:00**，AI数据超能学院第6期，我们邀请了上海人工智能实验室算法实习生、中山大学硕士 叶俊言 带我们走进跨视角任务，了解融合了卫星遥感及街景BEV特征的跨视角分割、以及基于全景-BEV联合网络的跨视角检索策略，如何成功进行城市建筑物精细属性感知以及街景图像定位。

  

对多模态数据、建筑重建、跨视角任务等内容感兴趣的朋友，快点击下方按钮预约直播吧~

  

**论文链接**

__https://www.arxiv.org/abs/2408.05475__

  

**数据集链接**

_https://opendatalab.com/OmniCity；_

_https://opendatalab.com/CVeRS/Cross-view；_

  

**亮点介绍：**

**1\. 基于遥感-街景跨视角数据，融合遥感与街景BEV特征的建筑物精细属性感知及分割方法SG-BEV分享**

**2\. 全景到BEV视图转换技术，实现街道与卫星视角融合，提升跨视角检索效率和准确性的策略分享**

****预约海报：****

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hkUN8E95VAVJjySAUibrPgFtFYG80SG8mM89KHOARGADeWeVlVjhFsb8dEA7GTtpEqSXicRGoAdplp9Rvsk2LjMA/640?wx_fmt=png&from=appmsg)

...
上节课，第五课讲师带大家深入实践了 MinerU Skill 的开发与应用（点击阅读原文，获取课程资料）。如果你已经掌握了 Skill 开发，正想更进一步，让 AI 能力的构建门槛低到——每个人都能用自然语言对话快速开发 Agent，那第六课进阶课程——《Vibe Coding 实战：基于 MinerU 搭建 AI Agent》你一定不能错过！

  

这节课，将带你深入了解 Vibe Coding 的核心理念与设计思路，并以 MinerU 的文档解析能力为底座，手把手教你快速搭建 AI Agent 原型。你不需要从零造轮子，也无需深陷复杂代码，只需跟随教程，用自然语言描述需求，就能把 MinerU 的强大能力集成到自己的智能体中，让 AI Agent 开发真正进入「对话即创造」的轻快模式。

  

对应的课程文档及视频已上架 MinerU 实战训练营主页，欢迎大家前往学习。本周三晚7点，我们邀请到 MinerU 产品经理 商富凯老师进行线上直播答疑。大家学完课程、做完实践后有任何疑问，都可以提前在评论区或社群留言，带着问题来直播间，一起碰撞灵感。

  

另外商富凯也是NanaDraw产品经理。NanaDraw是一个面向科研和论文写作场景的 AI 可编辑图示生成工具，可以把论文方法描述、关键词或手绘草图自动转成清晰的流程图、机制图和科研插图。它支持 Draft、Generation、Assembly 三种创作模式，内置 250+ 学术参考风格、Bioicons 图标库、个人素材库和 draw.io 编辑器，生成结果可继续编辑并导出为 SVG、PPT、XML 等格式，适合用来快速制作论文配图、项目汇报图和方法流程图。项目采用 React/Vite 前端与 FastAPI 后端，本地存储项目数据，不依赖云端保存。

  

目前网页体验端已经支持GPT-Image2模型，欢迎使用体验。
...
如果项目有帮到大家，可以给NanaDraw项目点个⭐️star！
...
**主题**：《Vibe Coding 实战：基于MinerU 搭建AI Agent》课程答疑

**讲师**：MinerU 产品经理 商富凯

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/uo0n2KqOLAZiaDSFzLCt66CIVXvmotL8VhzQBQ1fia4ZDZYwOBnGic8riaxyoP37d0gEibMqhib3Tzo6luSxatlLhYJ6aLLRgjztefza347iar6aUg/640?wx_fmt=jpeg)

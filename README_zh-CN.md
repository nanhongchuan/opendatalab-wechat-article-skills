...
OpenDataLab 微信文章知识库提供可安装的 Agent skill，以及可检索的 OpenDataLab 微信文章语料。

## 安装

在支持 GitHub skill 安装的 Agent 环境中，可使用：

> 安装 github.com/nanhongchuan/opendatalab-wechat-article 这个 skill。
...
| 路径 | 说明 |
|------|------|
| `.claude-plugin/marketplace.json` | 插件注册元数据 |
...
用户提出请求
  ...
  -> 仓库缓存创建或更新到 ~/.cache/opendatalab-wechat-article

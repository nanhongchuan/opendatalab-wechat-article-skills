...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD4UehWVRNBDfnibL8AWBg1dmj28caqOsoA76TYBIgbTNw2RPRmcG4jZXibAfDmdsOEq4b027gZGl9zQ/640?wx_fmt=jpeg&from=appmsg)
...
最近，一夜爆火的 AI 自动生成视频工具——Pika，让多模态方向的视频生成、视频理解任务研究变得炙手可热，吸引了不少 AI 同行投入其中。

  

作为一个涉及计算机视觉、深度学习、自然语言处理等多个领域的综合性研究主题，视频生成和视频理解在众多应用场景中具有重要的研究意义和价值。然而，目前还缺乏统一的标准来衡量不同算法在这些任务上的性能优劣，这也限制了相关技术的进一步发展和推广。

  

**12月6日（周三）19:00** 让我们跟随**上海人工智能实验室青年研究员 何逸楠**的分享，深入了解视频生成与视频理解的benchmark及相关研究，欢迎报名~
...
**2\. 2个最新、原创的评测数据集研究及介绍**

● 全面的多模态视频理解基准 MVBench

● 视频生成模型综合基准套件 VBench

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD4UehWVRNBDfnibL8AWBg1dm5VDrdfxKNh2D7uRTXUiaEWgVkGkhquxt8PuUFfV4GGAIzpLAjgryWUg/640?wx_fmt=jpeg&from=appmsg)

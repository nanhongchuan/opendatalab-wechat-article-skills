...
大模型时代，AI 研究者常常面临着从海量文档中提取高质量数据的挑战。如何从格式、排版纷繁复杂的学术文献、行业报告、课本、试卷、网页、书籍等PDF文档中，快速提取高质量数据？利用大模型、RAG 等技术，结合专业文档，打造垂直领域的新知识引擎？**复杂 PDF提取开源工具——MinerU** ，提供了不错的方案。其凭借精准、快速、开源的特点，正在成为AI数据处理炙手可热的必备组件。

  

**11月20日（周三）19:00，AI数据超能学院第3期，我们邀请了****上海人工智能实验室大模型数据基座 OpenDataLab 数据提取工程师  MinerU核心开发者 赵小蒙**详细介绍MinerU最新功能及模型效果，帮大家更快速地上手MinerU工具，熟悉其模型、代码构成，更好地基于各自需求进行魔改、开发，打造专有的知识引擎，欢迎预约观看！
...
**MinerU PDF转Markdown 线上体验：**

_ht__tps://opendatalab.com/OpenSourceTools/Extractor/PDF_
...
**2. MinerU部署、使用、二次开发等常见问题答疑**

****预约海报：****

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hkUN8E95VAVnSwT2DFTJicSwKduNibp7BtC48pAyWmIVUJtvzRT3cxZQ8evyx3ZNOVNxtU3Vjmwcg3uXjmQTUIEA/640?wx_fmt=png&from=appmsg)

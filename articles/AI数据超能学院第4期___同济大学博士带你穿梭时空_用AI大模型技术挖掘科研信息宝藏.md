...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hkUN8E95VAVnSwT2DFTJicSwKduNibp7BtQmZoTrN3dl7ToMThFMJlv5nVdhZqKxytXQdORL27XcIBecuew2MI7Q/640?wx_fmt=png&from=appmsg)

**【AI 数据超能学院】直播活动介绍**

OpenDataLab 人工智能数据开放社区联合中国人工智能产业发展联盟数据委员会为代表的多家合作伙伴，共同推出了“**AI数据超能学院**”系列直播活动。邀请AI领域的专家和原创数据作者、AI开发者，选取最新的开源数据集和最前沿的数据处理工具，定期直播分享，带大家深入学习AI数据处理、使用、扩展的方方面面，**扫清各类数据“障碍”，解决各类数据“疑难杂症”**。最新AI数据资讯和使用秘籍尽在这里！
...
想象一下，一个数据集，它像一部跨越三个世纪的科研史诗，记录了从1900年至今的每一次科学浪潮……**智创数据库**，一个包含了超过**9231万条**学术论文，**18亿余**条论文引用关系信息数据量；**3万余条**科研基金信息数据量，**6128万余条**论文基金关系；**1亿余****条**专利数据量，**1.1亿余条**专利法律状态相关数据的数据集，不仅见证了从蒸汽机到人工智能的每一次技术飞跃，也将帮助大家揭示推动这些变革背后的秘密。

（点击查看智创数据集介绍：[免费下载 | 横跨120余年，数亿条学术数据，大规模学术数据库“智创”开源](http://mp.weixin.qq.com/s?__biz=MzkxMDc0MDU5Mg==&mid=2247547347&idx=1&sn=cd176071fc79af4c2660ea477a0900dc&chksm=c124a4ccf6532dda77cebce2bc683d752ff55b5c8356034110444e6ee4d97d120be599d0684f&scene=21#wechat_redirect)）

  

**11月27日（周三）19:00**，AI数据超能学院第4期，让我们跟随**同济大学博士、****博观创新 **副总经理** **邢移单****穿梭时空，结合AI大模型技术，一起挖掘这些科研信息宝藏，了解全球、多学科科研脉络及趋势，开启你的智能科研探索之旅！

  

**智创数据集链接：**

__https://opendatalab.com/Gracie/IID__
...
**1.** **学术知识全景数据库——智创数据集背景介绍；**

**2\. 学术论文、专利、科研基金等数据构成及处理、分析介绍；**

**3\. 智创数据集学术价值及研究成果介绍**

****预约海报：****

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hkUN8E95VAXq43ddwD2YEeLLJ49KJxXEVjSA0mkP7l0ibToY1CgEpzFiam4f60U3icgoApkkYQWaib0LQxTibWwwfWw/640?wx_fmt=jpeg&from=appmsg)
...
中国人工智能产业发展联盟数据委员会、bilibili、示说网
...
还有哪些想进一步学习、了解的数据内容，快来告诉小助手吧，我们来安排
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD6nukKCt3UYlDgzYB0rWHFbNxCPQrNamw97YnVs8fEYAibArB8whO4eIf3AA8ICFv8Vu2Purce3FvA/640?wx_fmt=jpeg)

发布你的原创数据集，欢迎使用OpenDataLab平台，扫码直达↓
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hkUN8E95VAXq43ddwD2YEeLLJ49KJxXEmAe9qtcaHRgb1kvgdIWKibjkyYsticZA8QwvpSORz773dG34FOiaeaYdA/640?wx_fmt=jpeg)

](https://mp.weixin.qq.com/s?__biz=MzkxMDc0MDU5Mg==&mid=2247549035&idx=1&sn=d60e19c69157e64af4c2f65b6e16f317&chksm=c1249d74f6531462d1aa4f5fa77e3892bec0cb38e638dc4d5a6a3aaa58fe2a9801b7f1b960b4&scene=21#wechat_redirect)

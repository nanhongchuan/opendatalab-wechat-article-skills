...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/7yjDpC9UfD4WEU8wVfRJ0TG7ZSMMg3z89DcttrPw6cYYkhPFXCVhya17mwc2PF9EPXRkzicvTUiba057GqWla4NA/640?wx_fmt=png&from=appmsg)
...
最近火爆的多模态大模型，给我们展示了一个充满无限可能的未来，AI不仅能理解文字，还能读懂视频、自动生成视频，无一不说明着人类与数字世界的互动方式正在发生前所未有的改变。然而，如何构建一个强大、可迁移的视频理解和生成AI大模型？如何扩展它在大规模视频内容检索、生成和交互方面的潜力？

  

**1月10日（周三）19:00**  **上海人工智能实验室青年研究员 香港中文大学博士** **王毅**将揭开视频理解与生成大模型的神秘面纱，分享他们最新研究成果与项目资源，带你一探究竟，扫描海报二维码预约观看~

**亮点介绍：**

**1\. 多模态视频理解任务综述**

**2\. 大规模以视频为中心的多模态数据集高效构建流程**

**3\. InternVid超强视频理解性能及应用介绍**

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/7yjDpC9UfD7lsmMpdzY24uRJMglVzfHhLHo5pKhCRUydt2y2K4atXyRNNfqsnSHjtZKVAnngsIXuEibmfAvPKBg/640?wx_fmt=jpeg&from=appmsg)

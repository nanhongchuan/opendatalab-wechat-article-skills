...
上周，第三课2位讲师给大家详解了 MinerU 在线 API如何深度调用（点击阅读原文，获取课程资料）。如果你正苦恼于MinerU在某些特定垂直场景提取效果不够理想，想要自己动手微调 MinerU VLM模型，那四节进阶课程——《MinerU 1.2B 模型微调》你一定不能错过！

  

这节课，将带你基于 MS-SWIFT 框架，通过 SFT (Supervised Fine-tuning) 流程，对 MinerU2.5模型（MinerU2.5-2509-1.2B） 进行针对性的微调。你不需要从零开始，只需跟随步骤，就能让MinerU模型更懂你的业务场景，大幅提升关键信息的识别精度，最终拥有一个为你量身定制的高效文档解析模型。

  

对应的课程文档及视频已上架 MinerU实战训练营主页，欢迎大家前往学习。本周四邀请了讲师进行集中的线上直播答疑。欢迎大家学完课程、做了作业，带着问题来直播间交流。
...
**主题**：《MinerU 1.2B 模型微调》课程答疑

**讲师**：MinerU 算法工程师 吴凡

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/uo0n2KqOLAbrslodcj09rDDichHVXQAbmWJsu8WYy2ChrYtVCUdPjclXgY4UBx5dl8AbeyvLicaMiaXFEsTuicOHPiaLjTa0VXggR47HnVYCrd6s/640?wx_fmt=png&from=appmsg)

...
上周，第四课讲师给大家带来了 MinerU 1.2B 模型微调的深度实践（点击阅读原文，获取课程资料）。如果你已经掌握了模型调优的方法，正想把这套能力封装成开箱即用的工具、让团队成员也能一键调用，那第五节进阶课程——《**OpenClaw Skill 开发实践：基于 MinerU 的文档灵活问答**》你一定不能错过！

  

这节课，将带你深入了解 MinerU 官方 Skill、MCP Server 的设计理念和使用方法，并以 **MinerU Ask PDF** 为例，手把手教你开发一个针对文档灵活问答的 Skill。你不需要从零造轮子，只需跟随教程步骤，就能把 MinerU 的文档解析能力快速集成到自己的工作流中，打造一个智能化的文档问答助手，让非结构化文档真正「开口说话」。

  

对应的课程文档及视频已上架 MinerU 实战训练营主页，欢迎大家前往学习。本周四邀请了讲师进行集中的线上直播答疑。欢迎大家学完课程、做了作业，带着问题来直播间交流。
...
**主题**：《OpenClaw Skill 开发实践：基于MinerU 的文档灵活问答》课程答疑

**讲师**：MinerU 客户端工程师 林德臣

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/uo0n2KqOLAbs37Y00hsVUycj7nK894gg92HgZqzxRkiakI3EXh50RZibqNPkKUYV2ibO5QDfa04IPTxZGic0q7FDIQOjKFaD4u7NN8lSv62HeEM/640?wx_fmt=png&from=appmsg)

...
复杂PDF数据提取神器—— MinerU，为何总能快速、准确地识别出文档要素？原来是团队自研的布局检测模型DocLayout-YOLO提供了核心能力。

  

**1月7日（周三）19:00**，**AI数据超能学院第7期，我们邀请了两位嘉宾进行分享**：上海人工智能实验室 算法工程师、 DocLayout-YOLO模型核心开发者 赵致远将带来DocLayout-YOLO 模型详解，带你全方位了解布局检测算法、掌握 DocLayout-YOLO模型微调技能；同时，社区开发者 张朝滨，将分享他优化 DocLayout-YOLO 模型的实践经验。

  

快点击下方按钮预约直播，一起get布局检测能力~

  

**DocLayout-YOLO Github主页：**

__https://github.com/opendatalab/DocLayout-YOLO/__

  

**亮点介绍：**

**1\. DocLayout-YOLO核心技术解析**

**2\. DocLayout-YOLO模型微调方法介绍**

**3\. 社区开发者优化经验分享：如何优化DocLayout-Yolo，在精度和速度上实现了显著提升**

****预约海报：****

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hkUN8E95VAV3wq163MnZpCxvHO5AVXKSS2wzw3dlARicXGj9meibEvXSYY7mAdUlTZ4v12AlVCAReZc5BLHiaDdxA/640?wx_fmt=png&from=appmsg)

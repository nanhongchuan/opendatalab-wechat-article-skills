...
在AI领域，CLIP模型因其在视觉语言任务中的表现而备受瞩目，然而，研究者们发现，CLIP模型容易过度关注图像中嵌入的视觉文本，而忽略了真实的视觉语义，这个潜在问题这不仅影响会模型的准确性，也限制了其应用范围。

  

**12月4日（周三）19:00**，AI数据超能学院第5期，中南大学特聘教授，新加坡国立大学博士 王金鹏 将深入探讨他们如何发现并揭示文本定位偏差的根源，同时以Laion-2B为例，分享如何重构CLIP数据处理策略，并在此基础上重新训练了CLIP模型。

  

这场直播将为AI领域的研究者和开发者提供新的视角和思路，快点击下方按钮预约直播吧~

  

**100M Text Debiased Subset from LAION 2B 数据集链接：**

__https://opendatalab.com/opendatalab-linyiqi/LAION-text-debiased-100M__

  

**Parrot Captions Teach CLIP to Spot Text论文：**

_https://simg.baai.ac.cn/paperfile/d669125c-b10b-421f-9256-738e030e1bc9.pdf_

  

**亮点介绍：**

**1\. 规模过大，视觉-语言预训练数据如何缩减？**

**2\. 鹦鹉学舌式的图片-文本描述，导致CLIP模型语义理解偏差**

****预约海报：****

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hkUN8E95VAXFYzUuWOmGuJdEcENxVic4WSFRb4zIvnxsNp3PEvueggCdtUhx8DfWmDfSms2roMDc7gwSLR0bg0g/640?wx_fmt=png&from=appmsg)

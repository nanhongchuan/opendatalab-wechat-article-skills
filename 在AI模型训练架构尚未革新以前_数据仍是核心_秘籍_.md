...
****AI见闻**：**那大模型再想得到能力提升，是否有突破瓶颈的现实路径？
...
****AI见闻**：**关注到您是开源项目OpenDataLab和 MinerU的创始人，这两个项目在开发者社区中获得广泛的认可，您觉得开源对AI发展生态到底意味着什么？为什么会坚持走开源这条路？
